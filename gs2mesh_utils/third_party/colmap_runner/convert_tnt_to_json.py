...
from utils.database import COLMAPDatabase  # NOQA
from utils.read_write_model import read_model, rotmat2qvec  # NOQA
...
def init_colmap(args):
    ...
    for scene in scene_list:
        ...
        print('Writing data to json file: ', os.path.join(scene_path, 'scene.json'))
